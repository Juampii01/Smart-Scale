      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {(["nueva","revisada","aceptada","rechazada"] as const).map(s => (
            <div key={s} className="rounded-2xl border border-zinc-200 bg-white px-4 py-3.5 dark:border-white/[0.07] dark:bg-[#111113]">
              <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 capitalize dark:text-white/25">{s}</p>
