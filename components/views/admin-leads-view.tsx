            ...
            <button
              ...
              className={`h-8 rounded-xl border px-3 text-[12px] font-medium transition-all ${
                filterRating === 0
                  ...
                  : "border-zinc-300 bg-white text-zinc-600 hover:text-zinc-900 hover:border-zinc-400 dark:border-white/[0.07] dark:bg-transparent dark:text-white/40 dark:hover:text-white dark:hover:border-white/20"
              }`}>
              Todas
            </button>
            <button
              ...
              className={`h-8 rounded-xl border px-3 transition-all flex items-center gap-1 text-[12px] font-bold ${
                filterRating === -1
                  ...
                  : "border-zinc-300 bg-white text-zinc-600 hover:text-amber-700 hover:border-amber-400 hover:bg-amber-50 dark:border-white/[0.07] dark:bg-transparent dark:text-white/40 dark:hover:text-amber-300 dark:hover:border-amber-400/30 dark:hover:bg-transparent"
              }`}>
