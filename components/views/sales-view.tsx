      ...
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <section className="space-y-4">
          ...
          <div className={`rounded-2xl border p-5 flex items-center justify-between ${
            ...
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-600 dark:text-white/40">Tasa de cierre</p>
              <p className="text-xs text-zinc-500 mt-0.5 dark:text-white/30">cierres / llamadas atendidas</p>
            </div>
