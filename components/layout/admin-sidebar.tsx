    ...
    <>
      ...
      <aside
        className={cn(
          ...
          // Flotante en desktop: despegado, redondeado, con sombra suave (igual que el portal cliente)
      ...
      >
        ...
        <div className={cn("flex-shrink-0 border-b border-foreground/[0.07] py-3", collapsed ? "lg:px-2 px-4" : "pl-5 pr-3")}>
