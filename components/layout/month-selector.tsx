        ...
        {months.map((m) => (
          <SelectItem
            ...
            className={
              m.disabled
                ? "text-foreground/30"
                : "text-foreground data-[highlighted]:bg-foreground/10 data-[highlighted]:text-foreground data-[state=checked]:bg-foreground/10 data-[state=checked]:text-foreground"
            }
          >
            {m.value}
          </SelectItem>
