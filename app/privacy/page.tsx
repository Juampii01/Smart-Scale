  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--background)" }}>
      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-5 pb-24 pt-10 space-y-8 text-foreground">
        <div>
          <h1 className="text-[24px] font-bold tracking-tight text-foreground">Política de Privacidad</h1>
        ...
        <section className="space-y-2.5">
          ...
          <p className="text-[15px] leading-relaxed">
            ...
            <a href="mailto:support@smartscale.space" className="text-accent-ink hover:underline">support@smartscale.space</a>.
          </p>
        </section>

        <section className="space-y-2.5">
          <h2 className="text-[15px] font-bold text-foreground">2. Qué datos recolectamos</h2>
          <p className="text-[15px] leading-relaxed">Según el tipo de cuenta, recolectamos:</p>
        ...
        <section className="space-y-2.5">
          ...
          <p className="text-[15px] leading-relaxed">
            ...
            <Link href="/data-deletion" className="text-accent-ink hover:underline">página de instrucciones de eliminación de datos</Link>.
          </p>
        </section>
