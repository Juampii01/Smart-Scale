...
const JOB_REGISTRY: RegistryEntry[] = [
  ...
  { key: "client-prospect-follow-up", name: "Seguimiento de prospectos del cliente", description: "Avisa por push cuando un cliente tiene un seguimiento vencido en su propio pipeline de prospectos.", trigger: "diario 12:00 UTC", bucket: "asistentes", source: "system_job_runs", sourceKey: "client-prospect-follow-up" },
